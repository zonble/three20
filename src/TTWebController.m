...
- (void)shareAction {
  if (nil != _actionSheet) {
    ...
    // The action sheet isn't already visible.
    _actionSheet = [[UIActionSheet alloc] initWithTitle:@"" delegate:self
...
#ifdef __IPHONE_3_2
    // On the iPad we want to display the menu directly above the action icon.
